...
var mergeSort = function MergeSort(arr) {
  var len = arr.length; // Do not need to sort the array if it only has 1 element

  if (len <= 1) return arr; // Calculate the middle

  var m = Math.floor(len / 2); // Divide the left half
